...
public class ManNumMesasFrame extends javax.swing.JFrame {

    private MeseroDAO meseroDAO;
    
    public ManNumMesasFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManNumMesasFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManNumMesasFrame().setVisible(true);
            }
        });
    }
